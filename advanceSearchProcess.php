...
$image_rs= Database::search("SELECT*FROM `images`WHERE `product_id`='".$ru_data["product_id"]."'");
...
<div class="col-xxl-3 col-xl-3 col-lg-4 col-md-4">
    <div class="product__item white-bg mb-30">
        <div class="product__thumb p-relative">
            <a href="<?php echo "singleProductView.php?id=" . $ru_data["product_id"]; ?>" class="w-img">
        ...
        <span class="price"><?php echo $ru_data["name"];?>
            <h6 class="product-name">
                <a class="product-item-link" href="<?php echo "singleProductView.php?id=" . $ru_data["product_id"]; ?>">
