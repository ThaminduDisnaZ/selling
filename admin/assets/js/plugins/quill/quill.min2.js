...
! function(t, e) {
    ...
    return function(t) {
        ...
        var p = n(4),
            ...
            S = function() {
                function t(e) {
                    ...
                    this.container.classList.add("ql-container"), this.container.innerHTML = "", this.container.__quill = this, this.root = this.addContainer("ql-editor"), this.root.classList.add("ql-blank"),

                 
                    
                    this.root.setAttribute("id", "pdescription"), this.root.setAttribute("value", "<?php echo($product_data[\"discription\"]) ?>>"), this.scrollingContainer = this.options.scrollingContainer || this.root, this.emitter = new g.default, this.scroll = w.default.create(this.root, {
                    ...
                    var s = this.clipboard.convert("<div class='' style=\"white-space: normal;\">" + o + "<p id=\"pgyyy\"><br></p></div>");
        ...
        x.blotName = "scroll", x.className = "ql-editor", x.id = "pgy", x.tagName = "DIV", x.defaultChild = "block", x.allowedChildren = [v.default, y.BlockEmbed, w.default], e.default = x
    }, function(t, e, n) {
        "use strict";
